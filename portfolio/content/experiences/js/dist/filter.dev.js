...
(function ($) {
  "use strict"; // 06. Sticky Header Js
  ...
  $('.portfolio-menu button').on('click', function (event) {
    ...
    event.preventDefault(); // console.log("Add class")
  });
  /*  9. Slick-activation */
  ...
  $('.testmonial-nav').slick((_$$slick = {
    ...
    nextArrow: '<button type="button" class="slick-next"><i class="fal fa-angle-right"></i></button>',
    centerMode: true
  }, _defineProperty(_$$slick, "focusOnSelect", true), _defineProperty(_$$slick, "centerPadding", 0), _$$slick));
  ...
  $('.testmonial-nav2').slick((_$$slick2 = {
    slidesToShow: 3,
    slidesToScroll: 1,
    ...
    nextArrow: '<button type="button" class="slick-next"><i class="fal fa-angle-right"></i></button>',
    centerMode: true
  }, _defineProperty(_$$slick2, "focusOnSelect", true), _defineProperty(_$$slick2, "centerPadding", 0), _$$slick2));
  /*   h4team-active */
  ...
  $.scrollUp({
    ...
    scrollText: '<i class="fal fa-level-up"></i>',
    // Text for element
  ...
  function basicmap() {
    ...
    var mapElement = document.getElementById('contact-map'); // Create the Google Map using our element and options defined above
