...
(function ($) {
  $(document).ready(function () {
    ...
    var barsHeight = [[8, 22], [5, 10], [11, 8], [1, 27], [9, 1], [16, 3]];
    $('.equalizer').equalizerAnimation(250, barsHeight); // HAMBURGER AUDIO

    document.getElementById("hamburger-menu").addEventListener('click', function (e) {// document.getElementById("hamburger-hover").play();
